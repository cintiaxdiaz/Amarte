...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Amarte Creativo</title>
    <!--Titulo de la ARRIBA DE LA url-->
    <!-- favicon -->
    <link rel=icon href=IDENTIDADAMARTE-06.JPG sizes="20x20" type="image/png">
    <!-- Vendor Stylesheet -->
            ...
            <div class="container-fluid nav-container">
                <div class="row">
                    <div class="col-lg-3 col-4 order-1 align-self-center">
                        <div class="logo">
                            <a href="index.html"><img src="IDENTIDADAMARTE-06_opt.jpg" alt=""></a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="collection-style-02 margin-top-20">
                        <div class="thumb">
                            <img src="portada-accessories.jpg" alt="">
                            <div class="content">
                                <h3>ACCESSORIES</h3>
                                <h6>Collection</h6>
                                <div class="btn-wrapper">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="collection-style-02 margin-top-20">
                        <div class="thumb">
                            <img src="assets/img/collection/8.png" alt="">
                            <div class="content">
                                <h3>MEN'S</h3>
                                <h6>Collection</h6>
                                <div class="btn-wrapper">
                ...
                <div class="tab-pane fade in show active" id="one">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/arrival/5.png" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/arrival/6.png" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/arrival/1.png" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/arrival/2.png" alt="">
                                    <span class="sale">SALE 13%</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/arrival/3.png" alt="">
                                    <span class="sale">SALE 13%</span>
                ...
                <div class="tab-pane fade" id="two">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/tranding/4.png" alt="">
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                                    </ul>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/tranding/5.png" alt="">
                                    <span class="new">NEW</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/tranding/6.png" alt="">
                                    <span class="sale">SALE! 13%</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/tranding/1.png" alt="">
                                    <span class="out">SOLD OUT</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/tranding/2.png" alt="">
                                    <span class="sale">SALE 13%</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/tranding/3.png" alt="">
                                    <span class="sale">SALE 13%</span>
                                    <span class="new margin-top-35">NEW</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                ...
                <div class="col-md-12">
                    <div class="collection-slider-02">
                        <div class="collection-slider-item margin-top-20">
                            <div class="thumb">
                                <img src="assets/img/collection/13.png" alt="">
                        ...
                        <div class="collection-slider-item margin-top-20">
                            <div class="thumb">
                                <img src="assets/img/collection/14.png" alt="">
                                <div class="thumb-content">
                                    <h4>TOP TENDING</h4>
                                    <h2>40%</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-04 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/arrival/8.png" alt="">
                                    <span class="out">SOLD OUT</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-04 margin-top-40">
                                <div class="thumb">
                                    <img src="assets/img/arrival/13.png" alt="">
                                    <span class="sale">SALE 13%</span>
                                    <span class="new margin-top-35">NEW</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
    ...
    <div class="video-area margin-top-80 margin-bottom-75">
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-12">
                    <div class="video-content" style="background: url('assets/img/others/video.png') no-repeat center center/cover">
                        ...
                        <div class="widget contact-widget">
                            ...
                            <ul class="contact_info_list">
                                <li class="single-info-item">
                                    ...
                                    <div class="details">
                                        <span>Davis Patrick<br>P.O. Box 147 2546 Sociosqu Rd. <br>Bethlehem Utah
                                            02913</span>
                                    </div>
                                </li>
                                <li class="single-info-item">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <ul>
                            <li><a href="#"><img src="assets/img/payment/1.png" alt=""></a></li>
                            <li><a href="#"><img src="assets/img/payment/2.png" alt=""></a></li>
                            <li><a href="#"><img src="assets/img/payment/3.png" alt=""></a></li>
                            <li><a href="#"><img src="assets/img/payment/4.png" alt=""></a></li>
                            <li><a href="#"><img src="assets/img/payment/5.png" alt=""></a></li>
                            <li><a href="#"><img src="assets/img/payment/6.png" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
